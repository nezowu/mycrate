...
nnoremap <S-Right> :+tabm
nnoremap <S-Left> :-tabm
inoremap  u
let &cpo=s:cpo_save
unlet s:cpo_save
set background=dark
...
set ruler
set runtimepath=~/.vim,~/.vim/pack/vendor/start/hare.vim,/usr/share/vim/vimfiles,/usr/share/vim/vim82,/usr/share/vim/vim82/pack/dist/opt/matchit,/usr/share/vim/vimfiles/after,~/.vim/after
set scrolloff=5
set showcmd
set showtabline=2
